...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/products/import', \App\Livewire\Products\ImportProducts::class)->name('products.import')
        ->middleware('can:create products');
    Route::get('/products/import/template', [\App\Livewire\Products\ImportProducts::class, 'downloadTemplate'])->name('products.import.template')
        ->middleware('can:create products');
